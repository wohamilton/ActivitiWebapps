...
customPortal.service('ActivitiAPIService', function($http, $q){
    this.getData = function(url){
		//dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/runtime/tasks/' + $scope.selectedTaskId;
		dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/runtime/process-instances/134015/variables';
...
customPortal.controller('ProcessListController', function($scope, $route, $routeParams, $http) {
	...
	dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/repository/process-definitions?startableByUser=' + userIdValue;
...
customPortal.controller('StartEnquiryResponseController', function($scope, $route, $routeParams, $http) {
		...
		$scope.formInput = {processDefinitionId:selectedProcessId, businessKey:"myBusinessKey",variables: [{name:"enquiryDetails", value: {id: "ENQ123",enquiryDate: "01-01-2015",name: "Tom Brown", stayStartDate: "12-12-2014", stayEndDate: "12-12-2014", stayType: "longStay", cost: "350", responder: "Bill"}}]};
			...
			console.log(jsonVars);
			 ...
			 dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/runtime/process-instances';

			
			$http.post(dynamicUrl, jsonVars).
				success(function(data) {
					processInstanceId = data.id;
					dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/runtime/tasks?processInstanceId=' + processInstanceId ;
...
customPortal.controller('EnterEnquiryDetailsController', function($scope, $route, $routeParams, $http) {
		...
		dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/runtime/tasks/' + $scope.selectedTaskId + '/variables/responseTemplates';
		...
		$scope.createNew = function(){
			...
			$http.post(dynamicUrl, jsonVars).
				success(function(data) {
					...
					dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/runtime/tasks?processInstanceId=' + newProcessInstanceId ;
...
customPortal.controller('ReviewResponseController', function($scope, $routeParams, $http, ActivitiAPIService, $q) {
	...
	dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/runtime/tasks/' + $scope.selectedTaskId + "/variables";
...
function portalLoginController($scope, $http) {
	...
	$scope.login = function(){
		...
		dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/identity/users/' + $scope.userName;
...
function portalController($scope, $http) {
	...
	userIdValue = userId;
	dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/identity/users/' + userId;
	...
	dynamicUrl = 'http://kermit:kermit@entropic-entropicdev.rhcloud.com:80/activiti-rest/service/runtime/tasks?candidateOrAssigned=' + userId;
